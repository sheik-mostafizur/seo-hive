        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 2xl:max-w-7xl mx-auto">
          {data.map((item) => (
            <Slide key={item._id} top>
              <div className="text-center space-y-4 border dark:border-slate-800 p-4 rounded h-full shadow-lg shadow-primary-50 dark:shadow-slate-800 hover:shadow-xl hover:shadow-primary-50 bg-primary-50/50 hover:bg-primary-50 transition dark:hover:bg-primary-50">
                <Image
                  src={item.icon}
                  alt={item.title}
                  width={60}
